  ...
  return (
    <div className="border border-line-super-light rounded-[2.5rem] overflow-hidden p-[2rem] pb-0">
      ...
      <img
        src={car.main_image}
        alt={car.model}
        className="w-full h-90 md:h-64 md:w-110  object-cover rounded-[1.5rem]"
      />
      ...
      <div className="p-4 space-y-[2.6rem]">
        ...
        <div className="mt-4 flex justify-between gap-4">
          <Link
            ...
            className="bg-transparent text-line hover:bg-blue-500 hover:text-white py-2 rounded transition duration-300 text-4xl font-normal"
          >
            <FaChevronRight />
          </Link>
