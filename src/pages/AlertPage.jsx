    ...
    <section className=" py-6 md:py-8">
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-6 md:gap-8">
        ...
        <div className="w-full md:w-1/2 space-y-4 bg-forground p-[5rem] rounded-[2.5rem]">
          <h2 className="text-lg md:text-[3.6rem] font-semibold mb-[3rem]">Sobre nós</h2>
          <p className="text-sm md:text-4xl text-primary text-justify mb-14">
            ...
            de luxo e supersportivos. Com segurança, transparência e qualidade,
        ...
        <div className="w-full md:w-1/2 bg-forground rounded-[2.5rem] h-290 overflow-hidden">
          <img
            src={Pic}
            alt="Porsche Car"
